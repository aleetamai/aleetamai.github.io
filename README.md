...
<div class="row">
    ...
    <div class="column right" style="background-color:white;">
        ...
        <p style="color:black;">
My current research interests focus on the applications of differential topology, real algebraic geometry, and Morse theory in statistical learning theory, particularly in manifold learning and neural network theory.
        </p>
